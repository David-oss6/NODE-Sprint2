...
CREATE TABLE `pizzes` (
  ...
  CONSTRAINT `categoria_id` FOREIGN KEY (`categoria_id`) REFERENCES `categories_pizza` (`categoria_id`)
...
INSERT INTO `pizzes` VALUES (1,'Margarita','Es sosa','No hay imagen todavia',10.9,1),(2,'Barbacoa','Jamon y vaca','No img todavia',11.95,2),(3,'Napolitana','Con berenjena','No img todavia',9.95,3);
